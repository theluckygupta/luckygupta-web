...
export const TypewriterLoop = ({ phrases, className }: { phrases: string[]; className?: string }) => {
    ...
    return (
        <div className={cn('flex items-center text-2xl sm:text-4xl md:text-6xl font-bold', className)}>
            <span className="text-black dark:text-white">{displayed}</span>
            <motion.span
                className="ml-1 inline-block h-8 w-[4px] bg-blue-500 md:h-12"
                animate={{ opacity: [0, 1] }}
